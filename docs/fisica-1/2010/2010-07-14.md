...
$F_{e1}+\left(S_A+S_B\right)-{(P}_A+P_B)=0$
$F_{e1}={(P}_A+P_B)-\left(S_A+S_B\right)$
$F_{e1}=\ Vg\left(\rho_A{+\rho}_B\right)-2\rho_{H_2O}Vg$
$F_{e1}=Vg\left(\rho_A{+\rho}_B-2\rho_{H_2O}\right)=2,65\ N$
