...
??? question "Visualizza lo svolgimento"
    - $A : F_e1-F_e2+S_A-P_A=0$
      $B : F_e2+S_B-P_B=0$
      Sommando ambo i membri ottengo:
      $F_e1+(S_A+S_B\ )-\begin(P〗_A+P_B)=0$
      $F_e1=\begin(P〗_A+P_B)-(S_A+S_B )$
      $F_e1=\ Vg(\rho_A\ \begin+\rho〗_B )-2ρ_(H_2 O) Vg$
      $F_e1=Vg(\rho_A\ \begin+\rho〗_B-2ρ_(H_2 O) )=2,65 ∙10^(-3) N$
